...
// GLPubSub
#define COCOAPODS_POD_AVAILABLE_GLPubSub
#define COCOAPODS_VERSION_MAJOR_GLPubSub 1
#define COCOAPODS_VERSION_MINOR_GLPubSub 0
#define COCOAPODS_VERSION_PATCH_GLPubSub 1
